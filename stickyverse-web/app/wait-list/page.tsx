      ...
      <section className="hero">
        ...
        <div className="product-frame" style={{ marginTop: '64px' }}>
          ...
          <div className="product-inner">
            <img src="data:image/svg+xml;utf8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='1000' height='562' viewBox='0 0 1000 562'%3E%3Crect width='1000' height='562' fill='%23100D24'/%3E%3Ctext x='500' y='270' font-family='sans-serif' font-size='18' fill='rgba(255,255,255,0.4)' text-anchor='middle'%3EStickyVerse Digital Workspace%3C/text%3E%3Ctext x='500' y='300' font-family='sans-serif' font-size='13' fill='rgba(255,255,255,0.2)' text-anchor='middle'%3EYour aesthetic Chrome new tab page%3C/text%3E%3C/svg%3E" alt="StickyVerse product screenshot" className="product-img" style={{ opacity: 0.8 }} />
          </div>
        </div>
      </section>
